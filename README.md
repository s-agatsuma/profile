...
Scala に関わりたいと考えている。  
理由は、 Web アプリケーション開発に使用される関数型言語の中でも実績があり、 Java の資産を生かすこともでき、言語としても美しく、魅力的だと感じたためである。  

サービスの価値を考えた時に、メンテナンスのしやすさ、スケールのしやすさは重要であり、それを支える手法としてテストがある。  
...
- 予約システム
- MMORPG
    - [超建国ストラテジックファンタジー「クリスタル オブ リユニオン（クリユニ）」 公式サイト](http://www.cryuni.com/)
- アンケートシステム
- ブログパーツ作成システム
- 情報確認アプリ
- お問い合わせシステム
...
| 透明性の高い文化 | 信頼関係を築くため |
| プログラマーやテクノロジーに対しての理解とリスペクトがある社長 | 社長の考えが文化に反映されると考えているため |
